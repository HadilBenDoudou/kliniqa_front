...
import { NavMain } from "@/components/ui/administrateur/nav-main";
import { NavProjects } from "@/components/ui/administrateur/nav-projects";
  ...
  navMain: [
    {
      ...
      icon: SquareTerminal,
      isActive: true,
      items: [{ title: "Home", url: "/admin/administrateur" }],
    },
    {
      title: "Account",
      url: "#",
      icon: SquareTerminal,
      isActive: false,
      items: [{ title: "Pharmacie", url: "/admin/administrateur/pharmacie-user" }],
    },
    {
      title: "Models",
      url: "#",
